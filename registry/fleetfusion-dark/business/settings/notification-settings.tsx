...
import { Switch } from "@/registry/fleetfusion-dark/ui/switch"
import { Label } from "@/registry/fleetfusion-dark/ui/label"
import { Separator } from "@/registry/fleetfusion-dark/ui/separator"
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-white">Receive notifications when loads are completed</p>
              </div>
              <Switch
                id="email-load"
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-white">Receive notifications about vehicle maintenance issues</p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-white">Receive reminders about upcoming compliance deadlines</p>
              </div>
              <Switch
                id="email-compliance"
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-white">Receive notifications about financial reports</p>
              </div>
              <Switch
                id="email-financial"
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-white">Receive marketing emails and industry news</p>
              </div>
              <Switch
                id="email-marketing"
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-white">Receive in-app notifications when loads are completed</p>
              </div>
              <Switch
                id="app-load"
