...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter } from "@/registry/fleetfusion-dark/ui/dialog"
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-white">Add a new maintenance record</p>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-white">Add a new inspection record</p>
                  </div>
                  <Button variant="outline">
                      ...
                      <div key={inspection.id} className="border rounded-md p-4">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <div className="text-sm text-white">{formatDate(inspection.date)}</div>
                          </div>
