...
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from "@/registry/fleetfusion-dark/ui/card"
  ...
  return (
    <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={onClick}>
      <CardHeader className="pb-2">
        ...
        <p className="text-sm text-white">{load.customerName}</p>
      </CardHeader>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-white">{formatDate(load.pickupDate)}</p>
            </div>
          </div>
        </div>
      </CardContent>
          ...
          {load.vehicle ? (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs text-white">Vehicle:</span>
              </div>
