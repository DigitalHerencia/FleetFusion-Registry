              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-white">Add BOL, POD, or other documents</p>
                  </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="border-l-2 border-muted pl-4 py-2">
                    ...
                    <p className="text-xs text-white">2025-05-01 09:30 AM</p>
                  </div>
                  <div className="border-l-2 border-muted pl-4 py-2">
                    <p className="text-sm font-medium">Status changed to assigned</p>
                    <p className="text-xs text-white">2025-05-01 10:15 AM</p>
                  </div>
                  <div className="border-l-2 border-muted pl-4 py-2">
