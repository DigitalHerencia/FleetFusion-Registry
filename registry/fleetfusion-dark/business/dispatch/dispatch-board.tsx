...
import { LoadCard } from "@/registry/fleetfusion-dark/business/dispatch/load-card"
import { LoadDetailsDialog } from "@/registry/fleetfusion-dark/business/dispatch/load-details-dialog"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {loads.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10">
                <p className="text-white">No loads found.</p>
              </div>
            )}
          </div>
        </TabsContent>
        ...
        <TabsContent value="pending" className="mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {pendingLoads.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10">
                <p className="text-white">No pending loads found.</p>
              </div>
            )}
          </div>
        </TabsContent>
        ...
        <TabsContent value="assigned" className="mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {assignedLoads.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10">
                <p className="text-white">No assigned loads found.</p>
              </div>
            )}
          </div>
        </TabsContent>
        ...
        <TabsContent value="in_transit" className="mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {inTransitLoads.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10">
                <p className="text-white">No in-transit loads found.</p>
              </div>
            )}
          </div>
        </TabsContent>
        ...
        <TabsContent value="completed" className="mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {completedLoads.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10">
                <p className="text-white">No completed loads found.</p>
              </div>
            )}
          </div>
        </TabsContent>
