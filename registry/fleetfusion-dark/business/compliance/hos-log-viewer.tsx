...
import { Calendar } from "@/registry/fleetfusion-dark/ui/calendar"
import { Popover, PopoverContent, PopoverTrigger } from "@/registry/fleetfusion-dark/ui/popover"
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-white">View and manage driver hours of service records</p>
        </div>
              ...
              <TabsContent value="graph" className="pt-4">
                <div className="h-[300px] border rounded-md p-4 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-sm">Shows driving, on-duty, off-duty, and sleeper berth time</p>
                  </div>
                </div>
              </TabsContent>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-white">Available: 5:30</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium">On Duty Time</p>
                      <p className="text-2xl font-bold">8:00</p>
                      <p className="text-xs text-white">Available: 6:00</p>
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="rounded-md border p-3">
                    ...
                    <p className="text-xs text-white mt-1">70-hour/8-day rule</p>
