          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">2 drivers need attention</p>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">4 vehicles need attention</p>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-white">1 document expiring soon</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-white">Expires in 12 days</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-white">Due in 15 days</p>
                    </div>
                    <Badge variant="outline" className="bg-amber-50 text-amber-700 border-amber-200">
                      Due Soon
                    </Badge>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-white">Due in 22 days</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-white">Expires in 28 days</p>
                    </div>
                    <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200">
                      Upcoming
                    </Badge>
