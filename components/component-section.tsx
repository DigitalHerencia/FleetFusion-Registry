	...
	return (
		<section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden">
			...
			<div className="relative z-10 container w-full px-4 py-12 md:px-8 md:py-24 xl:px-32">
				{showTitle && (
					<div className="mb-24">
						<h1 className="mb-4 text-center text-5xl font-black text-white/90">
							Simple Transparent Pricing
						</h1>
						<h2 className="text-white mb-12 text-center text-xl">
					...
					{plans.map(plan => (
						<div
							...
							className={`flex flex-1 flex-col items-center rounded-2xl bg-white p-8 shadow-lg transition-transform duration-200 dark:bg-zinc-900 ${
								plan.highlight
									? 'z-10 scale-105 ring-2 ring-blue-200 dark:ring-blue-500'
									: ''
							}`}
						>
							...
							<ul className="mb-8 w-full space-y-2">
								{plan.features.map((feature, i) => (
									<li
										key={i}
										className="text-white flex items-center gap-2 dark:text-zinc-200"
									>
										<svg
				...
				<p className="mt-10 mb-10 text-center text-xs text-white">
